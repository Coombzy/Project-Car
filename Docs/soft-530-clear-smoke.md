...
Living this fold: Soft-530 is still **OPEN** (CF **1033** since 2026-09-13 ~11:57). Vault is independently **OPEN** (**502** since ~19:45 MT Sep 13 — **not** 1033). ListMachines **`Mac.lan` + `lightning`** — Docs **ABSENT** since Fri 2026-09-11 ~16:48 (**~4d** — **cold-boot** on reappear). This paper does **not** invent CLEAR.
...
| **Invent CLEAR** | Soft-530 still **OPEN** (CF **1033**). Vault still **OPEN** (**502**). **Mac.lan + lightning** / Docs **ABSENT ~4d**. |
