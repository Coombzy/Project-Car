...
**After extended OPEN:** when `Docs-MacBook-Pro` **first reappears**, the hop is [doc-reappear-first-hop.md](doc-reappear-first-hop.md) (assert machineId **`95a229f5-9296-4a18-aa98-70fd300dabdf`** — **never** `Mac.lan` / Porsche) **then** [soft-530-clear-smoke.md](soft-530-clear-smoke.md) (OPTIONS CORS + POST **422**/**201**) **before** Owner desk / **#79.1** / this menu. The **next** vault **CLEAR** runs [vault-clear-smoke.md](vault-clear-smoke.md) **first** (`/alive` **200** + `/api/config` McKing **2026.6.0** class + **502→200**) **before** Bitwarden / desk. Do **not** execute those smokes from this fold. Pointer: [soft-530-extended-open.md](soft-530-extended-open.md) · [cors-origins.md](cors-origins.md).
