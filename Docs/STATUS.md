...
- **Brochure P2-4:** **open** / plan only. Zone checklist: [brochure-security-headers.md](brochure-security-headers.md). Target Worker `projectcar-brochure` headers + HTML vs `?v=` cache split. Live Worker **200**s have **none** of those headers today. Do **not** apply from a docs PR — Zone implements after Lead GO. Do **not** invent P2-4 done.
...
Two gates — do **not** collapse them into “v1 includes everything forever.” Calendar (#18), fill (#20), placeholders (#21), cookies (#22), Docs (#23 / #25 / **#30–#58**, website **#52–#57**), schedule harden (#24), inventory (#26), Chat (#27), Dashboard (#28), shop-web host allowlist (**#36**, `f952cd3`), brochure P1-1 / P1-3 (**#52**, `5361212`), brochure P2-1 (**#55**, `453e44d`), brochure P2-2 (**#56**, `ed41d23`), and brochure P2-3 (**#57**, `be60a01`) are **on `main`** — they are not Next. P2-1 / P2-2 / P2-3 are **LIVE** on Worker. P2-4 stays **open** (Zone checklist landed in **#58** — not applied). **#36 is on `main` only** until Doc pull + rebuild. **`ops.projectcar.ca` is LIVE** at the edge. `app.` remains the temporary alias — do not cut it here.
