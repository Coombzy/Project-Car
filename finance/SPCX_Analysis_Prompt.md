...
**Version:** 1.19  
**Last edited:** 2026-09-18T16:45:00Z  
...
- **Live next-session 1d is `preliminary` until that session's official RTH close.** Auditor marks it; Daily does not close it mid-session. **2026-09-16** 1d closed on 9/17 official (L152.63 H156.87 C154.81; H156.87 > 156 miss). **2026-09-17** 1d is preliminary through 9/18 RTH.

## Process rules (always apply)

1. **ATR-proxy** — compute both (a) median true range of last 5 completed regular sessions and (b) published 14d ATR / 14d mean TR. State both dollar values. **Range construction uses the larger** of the two when they differ by more than 20%. TR = max(H−L, |H−prevC|, |L−prevC|) — never raw H−L. Recompute after every official EOD; do not copy the prior header. **After 9/17 official:** last-5 TRs 5.93 / 6.56 / 5.68 / 9.52 / 5.99 → median **$5.99**; 14d mean TR **$6.79**; differ 13% <20% → use **$5.99**. Do not reuse after-9/16 median $6.56 / header $6.61. After a 1d upper-exceed, do not tighten the next 1d high vs the miss print solely because last-5 median fell.
...
3. **Range construction**
   ...
   - Known-event extra HIGH and LOW stack: dated lock-up/unlock in next 10 RTH → +0.5×ATR to 1d/1w high AND −0.5×ATR from 1d/1w low. **Stacks on top of printed-high/low clearance** — printed-high floor does not consume the extra. Next dated unlock **2026-09-24**. **2026-09-14** 1d high $159 short (required >=$163 and <=$139). **2026-09-15** insert applied stack: 1d 137–163. **2026-09-16** 1d high $156 = printed +0.5×ATR without extra; extra required range_high >= **$158.16**; official 9/17 H **$156.87 > 156 miss**. Do not rewrite locked 9/16 bands. **2026-09-18** recovered 1d high $161 is short of stacked floor (~$162.59 using $5.99); do not rewrite. If stacked 1d high floor > printed range_high, widen range_high **before lock** (same for the low). Self-check must print stacked floors.
...
11. Close clocks: 1d = next RTH; 1w = 5th RTH after analysis_date; 1m = 21st; 3m = 63rd. **Day N/5 after 2026-09-17 official:** 9/10=5/5 (closed 9/17); 9/11=4/5; 9/14=3/5; 9/15=2/5; 9/16=1/5; 9/17=0/5; 9/18=0/5. Weekend 9/19–20 no increment. **9/18 mid-session no increment until official EOD.** 9/11 1w closes after 9/18 official RTH. 9/10 1w closed after 9/17 official.
