...
| [brochure-option-a-live.md](brochure-option-a-live.md) | Brochure Option A **LIVE** at edge — Zone Redirect **301** pack is pretty-URL SSOT (`/` `/shop` … → `*.html`); Worker `_redirects` stay thin; Home leftovers = **#82**. |
