...
**Last audited:** 2026-09-07 (P3-4 live-verified on Worker `projectcar-brochure` from Garage PR #65 / `f191ad5` — Zone Direct Upload ~18:46 America/Regina; smoke PASS apex+www: Shop 200 facility bullets (bays/hoists, shared fab, safety/cleanliness, structured shop) + honesty “intended shop capability — not live yet”; no 24/7 packaging on Shop; Membership still “24/7 shop access (when operational)”; Home still P3-1 pitch + `cta-hero` waitlist + Project Underway; no capability-bullet dump; `styles.css?v=34`; P2-4 headers still present). P2-1 / P2-2 / P2-3 / P2-4 / P3-1 / P3-5 already LIVE. P3-2 / P3-3 About stay **held / deferred**.  
...
| Check | Result |
|--------|--------|
| https://projectcar.ca / www | Worker `projectcar-brochure` Direct Upload of `apps/website/html` (P3-4 PR #65 / `f191ad5` **LIVE**; P3-5 PR #62 / `9d83bfc` **LIVE**; P3-1 PR #61 / `88c9820`; P2-4 **LIVE**; P2-3 PR #57 / `be60a01`; P2-2 PR #56 / `ed41d23`; P2-1 PR #55 / `453e44d`; P1-1 / P1-3 PR #52 / `5361212`). HTML from this agent often hits CF challenge (403); SSL in front is Cloudflare. |
