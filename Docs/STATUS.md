...
- **Member parts purchasing (full).** Placeholder on the Parts surface is **build-breadth (now)**. Full member purchasing is **Later**. Do not claim a shop is selling parts.
