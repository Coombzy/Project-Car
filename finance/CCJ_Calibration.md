...
**As of:** 2026-08-26 (seed from closed tracker rows Aug 15–24)  
**Sample:** closed 1d n=5 · closed 1w n=3 · open rows excluded
...
|--------|-------|
| Full hit | 2/5 (40%) |
| Partial (one side exceed, close inside) | 1/5 (20%) |
| Full upper exceed | 1/5 (20%) |
| Full lower miss / wrong direction | 1/5 (20%) |
| Median \|pct_error\| where calculable | ~1.3% (hits) · ~5% (misses) |

### Conditional (1d)

| Condition at prediction time | Outcomes | Takeaway |
|------------------------------|----------|----------|
| After Rel Vol ≥ 1.0× up-day (next session framed as digestion) | Aug 24 upper exceed | Do **not** center 1d below close; treat as trend-up until volume fades |
...
| Tight range under round number ($99.50 cap) | Aug 15 partial high | Round numbers are magnets, not walls |
...
**Takeaway:** 1w upside systematically tight after volume rebounds. Width ≥ 3.5× ATR-proxy; trend-up → upside leg ≥ 1.5× downside leg.

## Confidence calibration

Stated conf mostly 50–60%. Realized full-hit 1d ≈ 40% (60% if partial counts as near-hit). Prefer **honest width** over high conf. Do not raise conf above 60% for 1d until full-hit rate over last 10 closed 1d is ≥ 55%.

## Active rules derived from this table

1. Trend-up after Rel ≥ 1.0× → center 1d at/above close; never below.
2. 2+ upper-exceeds in last 3 closed 1d → +1.0× ATR-proxy on the high.
