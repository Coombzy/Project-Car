...
import { quoteBooking } from "../../../lib/shop-api";

export async function POST(request: Request): Promise<Response> {
  let payload: { start_at?: string; end_at?: string; member_id?: string };
  try {
    payload = (await request.json()) as { start_at?: string; end_at?: string; member_id?: string };
  } catch {
