...
Weekend coverage (`84107e7`) was Sat/Sun plan-improve-off. This lock is **not** weekend-only. It holds through the week until a host reappears **or** Ben reopens a named ask.
...
| **3** | **Lookout continues; companions HOLD until Ben reopens** | Lookout `api.` `/health` + vault `/alive` stay **armed**. Brochure-redirect watch paper **continues** ([brochure-redirect-watch.md](brochure-redirect-watch.md) — **to arm**; this fold does **not** arm). Soft-530 companions stay **HOLD / not armed** until **Ben reopens** — **not** weekend-only. Do **not** re-ask. |
