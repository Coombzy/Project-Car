...
| Weekend dual-OPEN recovery glue | [dual-host-outage.md](dual-host-outage.md) — Soft-530 OPEN + vault OPEN: **Doc first, then McKing**. ListMachines lock: `Mac.lan` ≠ `Docs-MacBook-Pro` ≠ `lightning`. Wake order only — post-CLEAR stay-up evidence is [doc-lid-restore.md](doc-lid-restore.md) |
| Soft-530 post-CLEAR stay-up evidence (next CF 1033) | [doc-lid-restore.md](doc-lid-restore.md) — after CLEAR, stamp cloudflared lastExit / KeepAlive loaded / caffeinate·CDM / Tailscale. Capture on Doc, not `Mac.lan` |
...
| [doc-lid-restore.md](doc-lid-restore.md) · [api-stay-up.md](api-stay-up.md) · [shop-web-stay-up.md](shop-web-stay-up.md) · [vault-stay-up.md](vault-stay-up.md) · [dual-host-outage.md](dual-host-outage.md) | Lid-close 530 / 1033 — **vault OUT** of lid-restore / Doc KeepAlive. Vault stay-up is McKing-only. Dual-OPEN **wake order**: Doc first, then McKing. Post-CLEAR stay-up evidence (lastExit / KeepAlive / caffeinate·CDM / Tailscale) is lid-restore |
