...
| **Shared** | **`shared_fleet_card_stale=true`**. Amend **HOLD** until next CLEAR recover + ≥30m + Shellable. Do **not** write OPEN-since-**~08:41** mid-flap. OPEN-since-**~07:06** queue **cancelled**. **CLEAR since ~07:25** queue **superseded** — **missed CLEAR window**. Do **not** backfill. |
