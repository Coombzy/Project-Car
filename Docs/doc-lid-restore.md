...
After **extended OPEN / quiet-ops**, do **not** start this sequence on a name-only ListMachines hit. First hop is [doc-reappear-first-hop.md](doc-reappear-first-hop.md): assert `Docs-MacBook-Pro` machineId **`95a229f5-9296-4a18-aa98-70fd300dabdf`**. **Never** treat `Mac.lan` or Porsche as Doc. Then this wake. Then [soft-530-clear-smoke.md](soft-530-clear-smoke.md).
