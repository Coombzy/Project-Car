...
Detail: `home-lab-specification.md` (skill/Desktop copies are fuller than the empty repo stub — restore that file in a later pass).
...
| `agent-profiles-specification.md` | Exists |
| `ai-agents-constitution.md` | Exists |
| `heartbeat-standards.md` | Exists |
| `security-playbook.md` | Exists |
| `home-lab-specification.md` | **Empty in this repo** — restore from skill/Desktop later |
...
1. Review these 2026-08-12 specs.
2. Phase 1 code: shop waitlist + booking, then MC cockpit.
3. Restore `home-lab-specification.md` into this repo when convenient.
