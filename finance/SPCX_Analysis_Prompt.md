...
**Version:** 1.16  
**Last edited:** 2026-09-14T16:45:00Z  
...
- **Live next-session 1d is `preliminary` until that session's official RTH close.** Auditor marks it; Daily does not close it mid-session. **2026-09-11** 1d stays preliminary through 9/14 tape.

## Process rules (always apply)

1. **ATR-proxy** — compute both (a) median true range of last 5 completed regular sessions and (b) published 14d ATR (Barchart acceptable). State both dollar values. **Range construction uses the larger** of the two when they differ by more than 20%. TR = max(H−L, |H−prevC|, |L−prevC|) — never raw H−L. Recompute after every official EOD; do not copy the prior header. **After 9/11 official:** last-5 TRs 5.93 / 9.81 / 7.92 / 9.86 / 3.53 → median **$7.92**; live 14d Barchart **$7.57** / Finviz **$7.68**; gap <20% → use **$7.92**. Do not reuse Daily-header $7.53 / $7.45 and do not freeze “after 9/10 = $9.81”.
...
11. Close clocks: 1d = next RTH; 1w = 5th RTH after analysis_date; 1m = 21st; 3m = 63rd. **Day N/5 after 2026-09-11 begin:** 9/03=5/5 (closed 9/11); 9/04=4/5; 9/08=3/5; 9/09=2/5; 9/10=1/5; 9/11=0/5. Weekend 9/12–13 no increment. **9/14 mid-session no increment until official EOD.** After 9/14 official: 9/04=5/5, 9/08=4/5, 9/09=3/5, 9/10=2/5, 9/11=1/5, 9/14=0/5.
...
17. **Write-streak emergency OFF (v1.16).** Streak **0** after 9/14 session-day 4-row INSERT commit **3470d780** / blob **6a6e68f3** (SHA-delta vs weekend 536ccee1). Dual-write + SHA-delta + payload-compact remain. If a future session day emits pre-write SHA or drops today's 4 rows, streak returns to 1 and emergency ON.
