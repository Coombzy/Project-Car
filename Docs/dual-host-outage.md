...
Living this fold — OPEN class honesty (do **not** invent CLEAR): Soft-530 still **OPEN** as CF **530** / **1033** since 2026-09-13 ~11:57 America/Edmonton (**~24h+** — quiet-ops [soft-530-extended-open.md](soft-530-extended-open.md)). Vault independently **OPEN** as **502** since ~19:45 MT Sep 13 — **not** 1033 — on `/alive` **and** `/api/config`. Docs **ABSENT** (home **EXPECTED** — [home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md)). ListMachines **`Mac.lan` + `lightning`** — `Mac.lan` ≠ `Docs-MacBook-Pro` ≠ `lightning` (living is still **home/lab / pre-cutover**; camp cutover paper **ready, pending Ben GO**). Option A Redirect **PASS**. Brochure Option A **LIVE** (FULL 10/10; `waitlist.js?v=3`; `styles.css?v=36`; Home bare `href="/"` + canonical/og apex until **#82**) — public SSOT during extended OPEN. Freeze intact **`4cf8924`** / **`5swmVz`**. **#82** still Ben GO.
