...
**Follow-up ~08:41 2026-09-16:** Soft-530 **CLEAR→OPEN**. Morning CLEAR dwell **~07:25–~08:41** (~1h16m) **ENDED**. **`soft530_open_since` ~08:41**. ListMachines still **EMPTY**. **EMPTY ≠ cause of OPEN.** Receipt: [overnight_2026-09-16_0841_open_verify.md](overnight_2026-09-16_0841_open_verify.md). This CLEAR + public MATCH line is **superseded as living**.
