...
| **Chat AI / Grok / Matrix bridge** | Chat v1 human/polling LIVE. Brochure Chat page stripped. | **CUT** / **DEFER** | Do not elevate Chat v1. Matrix retired. Apex **deferred**. | Grok on projectcar.ca, assign / staff notes / escalate, websockets = Later. Member booking assistant = Later. Do not revive Matrix or Apex. |
