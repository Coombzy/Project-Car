...
| **Invent vault CLEAR / invent dual CLEAR** | Soft-530 is **CLEAR**. Vault still **OPEN** (**530 / CF 1033**). ListMachines **Docs + lightning CONNECTED**. Soft-530 **CLEAR** + vault **1033** is still half-state ≠ this card. |
