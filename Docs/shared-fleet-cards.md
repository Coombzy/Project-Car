...
|-------------|--------------|
| **Soft-530 (Doc)** | **CLEAR** since **~07:25** America/Edmonton — Lead `api.` `/health` **200**; `app.`/`ops.` **307**. Dwell **≥51m** at **~08:16**. **`soft530_open_blip` ~07:06–~07:25**. ListMachines **EMPTY**. **`freeze_build_id_public=true`**. Half-state **living**. |
