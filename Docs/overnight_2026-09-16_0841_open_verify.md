...
| `shared_fleet_card_stale` | **`true`** — Shared amend **HOLD** until next CLEAR + ≥30m SAME-CLASS + **CONNECTED+Shellable** ([soft-530-blip-recover.md](soft-530-blip-recover.md)). Do **not** write OPEN-since-**~08:41** mid-flap |
...
**Locks:** dual OPEN both 1033 ≠ dual CLEAR. **EMPTY ≠ cause of OPEN** (OPEN is public HTTP). Camp GO / Shared amend **HOLD** until CLEAR + ≥30m + Shellable. ≠ auto lid-restore nag (Ben already aware). ≠ unfreeze / **#82** / **#79.1** / camp. **Do not enter** [post-dual-clear-go.md](post-dual-clear-go.md).
