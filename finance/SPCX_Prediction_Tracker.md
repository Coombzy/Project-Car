...
Last price context: 2026-08-28 official RTH (SpaceX IR / Yahoo) O **$139.82** H **$143.29** L **$137.90** C **$141.50** (+0.63 / +0.45%) Vol **55.11M** (~0.47× vs Barchart 20d **117.2M**; ~0.48× vs Yahoo 20d ~114.7M). Prior close $140.87. After-hours 8/28 ~$140.95 (−0.39%). Barchart 14d ATR **$8.47**. **Auditor 2026-08-30 Sunday:** session closed; no new rows; no new horizon closes. Closed 1d **2/2 hit** (8/26, 8/27). No closed 1w. 8/28 and 8/29 1d both map to 8/31 — grade both, do not expire. Path actuals current thru 8/28 RTH. 8/26 1w Day 2/5 (closes after 2026-09-02).
...
| 2026-08-29 | 1d | 132 | 152 | 141 | 152 | 45 | digestion | below-avg | 0.45 |  |  |  |  |  |  | open | weekend analysis (pre-rule-10); next-session 2026-08-31 RTH (overlaps 8/28 1d — grade both, do not expire); ATR-proxy 8.50 (14d); last-5 median TR ~5.08 |
