...
**Home-off does not queue this hop.** While Docs stay **ABSENT** at home, Soft-530 **OPEN** is **EXPECTED** ([home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md)). ABSENT duration is **not** this hop firing and **not** a Ben Doc-wake page. Lead stays armed **for actual reappear** only.

**Camp after Ben GO cutover:** if Soft-530 + vault are dual **OPEN**, recovery is **this** Doc hop (CDM / KeepAlive / cloudflared) — **not** McKing docker, **not** independent [mcking-reappear-first-hop.md](mcking-reappear-first-hop.md). This file does **not** re-cutover ([camp-vault-on-doc-cutover.md](camp-vault-on-doc-cutover.md) already owns that path).
...
Living this fold: Soft-530 is still **OPEN** (CF **1033** since 2026-09-13 ~11:57). Vault is independently **OPEN** (**502** since ~19:45 MT Sep 13 — **not** 1033; docker dead). ListMachines **`Mac.lan` + `lightning`** — `Docs-MacBook-Pro` is **ABSENT since Fri 2026-09-11 ~16:48** America/Edmonton (**~4d**). **Home-off expected** ([home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md)) — ABSENT duration does **not** fire this hop. **When** Doc reappears, that reappear is **cold-boot** class — **not** overnight sleep. McKing first-hop already ran ~19:10 ([mcking-reappear-first-hop.md](mcking-reappear-first-hop.md)) — that ListMachines DIFF is stamp-absorbed; **no morning Doc-wake re-ask** from `lightning` being back. This hop still waits on `Docs-MacBook-Pro` + machineId **`95a229f5-9296-4a18-aa98-70fd300dabdf`**. Option A **PASS**; Soft-530 UX **LIVE**; Lookout **both chronic HOLD today**; **#82** Ben GO only. This paper does **not** invent a Doc reappear or a CLEAR.
...
## Vault CLEAR stays independent at home; couples at camp after GO

**Home/lab:** this hop is **Doc Soft-530 only**. Vault may CLEAR or OPEN independently on McKing.

**Camp after Ben GO** ([home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md) · [camp-vault-on-doc-cutover.md](camp-vault-on-doc-cutover.md)): Soft-530 + vault share Doc. Dual **OPEN** uses **this** hop (CDM / KeepAlive / cloudflared) — **not** McKing docker.
...
| **Home-off ABSENT ≠ this hop** | Docs **ABSENT** + Soft-530 **OPEN** at home is **EXPECTED** ([home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md)). Do **not** auto-queue this hop or lid-restore from ABSENT duration. Do **not** treat home 1033 as camp cutover failure. |
...
- Auto-queue this hop / lid-restore / KeepAlive from home-off Docs **ABSENT** duration ([home-vs-camp-doc-posture.md](home-vs-camp-doc-posture.md))
- Treat home Soft-530 **OPEN** as camp cutover failure
- Walk [mcking-reappear-first-hop.md](mcking-reappear-first-hop.md) / McKing docker as the camp dual-OPEN path after Ben GO cutover
