...
|------------|---------------------|-------------|-------------------------------------------|------------------|
| 2026-09-23 | 86                  | (pending)   | Official EOD C$90.80 Rel 0.81x trend-down; 8th session under 50-DMA; pair flag vs U3O8 -4.01pp; rule 7 ON wick 0.93xATR; log restore after truncate; backfill Sep 21+22 tracker; prompt v1.14 | Yes |
