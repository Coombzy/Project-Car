...
**Current prompt versions (as of 2026-09-16 audit):** Analysis **v1.13** · Audit **v1.4** · Write rules **v1.1** · **Calibration.md live**  
...
|------------|---------------------|-------------|-------------------------------------------|------------------|
| 2026-09-17 | 86                  | (pending)   | Official EOD C$92.80 Rel 0.78x trend-down; 4th session under 50-DMA; pair flag vs U3O8 +2.37pp; Sep 16 1d HIT | Yes |
